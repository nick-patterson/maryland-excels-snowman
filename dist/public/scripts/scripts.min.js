...
function isTouchDevice(){return"ontouchstart"in window||"onmsgesturechange"in window}var snowman={canvas:"",isSharePosition:!1,isDead:!1,toModify:"",snowmanElements:{hat:[],face:[],head:[],torso:[],arms:[],base:[],scene:[]},scale:"",current:{hat:0,face:0,head:0,torso:0,arms:0,base:0,scene:0},init:function(){snowman.toModify=$(".build-toolbar-button-active").data("target"),snowman.draw()},draw:function(){function e(e,n){return e.height*(n/100)}function n(e,n){return e.width*(n/100)}function t(){B.forEachObject(function(e){B.remove(e)}),C.clear(),B.destroy(),j=snowman.snowmanElements.base[snowman.current.base].image,M=snowman.snowmanElements.torso[snowman.current.torso].image,S=snowman.snowmanElements.arms[snowman.current.arms].left,U=snowman.snowmanElements.arms[snowman.current.arms].right,x=snowman.snowmanElements.head[snowman.current.head].image,X=snowman.snowmanElements.face[snowman.current.face],H=snowman.snowmanElements.hat[snowman.current.hat],O=new fabric.Group,T=new fabric.Group,O.add(S),O.add(M),O.add(U),T.add(x),T.add(X),T.add(H),B.add(j),B.add(O),B.add(T),j.originX="center",j.originY="center";var n=(j.getWidth(),j.getHeight());j.top=n/2,O.originX="center",O.originY="center";var t=M.getHeight(),o=M.getWidth();O.top=-.75*t,O.left=-.5*o;var s=S.getWidth();S.getHeight(),U.getWidth(),U.getHeight();T.forEachObject(function(e){e.setScaleX(.4),e.setScaleY(.4)});var i=x.getHeight(),m=x.getWidth(),r=X.getHeight(),l=snowman.snowmanElements.face[snowman.current.face].getWidth();X.top=i/2-r/2,X.left=-1*(l/2);var c=H.getHeight(),d=H.getWidth();if(0===snowman.current.hat)switch(snowman.current.head){case 0:H.top=-1*(i/2.5+c/2),H.left=-1*(d/2.1);break;case 1:H.top=-1*(i/2.85+c/2),H.left=-1*(d/2.15);break;case 2:H.top=-1*(i/2.75+c/2),H.left=-1*(d/2.3)}else H.top=-1*(i/2.1+c/2),H.left=-1*(d/2.1);switch(T.originX="center",T.originY="center",x.left=-.5*m,T.top=-1*(.75*t+.75*i),snowman.current.torso){case 0:S.top=-1*(t/1.4),S.left=-1*(o/2+s/2),U.top=-1*(t/2),U.left=o/1.2,1===snowman.current.head&&(T.left=6,T.top=-1*(.75*t+.75*i)-8);break;case 1:S.top=-1*(t/2),S.left=-1*(o-s/9),U.top=-1*(t/2.75),U.left=o/1.2,1===snowman.current.head?T.top=-1*(.75*t+.92*i):T.top=-1*(.75*t+.8*i);break;case 2:1===snowman.current.arms?(S.top=-1*(t/1.8),S.left=-1*(o/1.05),U.top=-1*(t/2.75)):(S.top=-1*(t/2),S.left=-1*o,U.top=-1*(t/2.75)),U.left=o/1.3,1!=snowman.current.head?T.top=-1*(.75*t+.6*i):T.top=-1*(.75*t+.7*i);break;case 3:S.top=-1*(t/1.3),S.left=-1*(o/2+s/2.5),U.top=-1*(t/1.8),U.left=o/1.4,M.bringToFront(O);break;case 4:S.top=-1*(t/2),S.left=-1*(o-s/4.5),U.top=-1*(t/2.75),U.left=o/1.2,1===snowman.current.head?T.top=-1*(.75*t+.92*i):T.top=-1*(.75*t+.8*i),M.bringToFront(O);break;case 5:1===snowman.current.arms?(S.top=-1*(t/1.8),S.left=-1*(o/1.15),U.top=-1*(t/2.75)):(S.top=-1*(t/2),S.left=-1*(o/1.1),U.top=-1*(t/2.75)),U.left=o/1.3,1!=snowman.current.head?T.top=-1*(.75*t+.6*i):T.top=-1*(.75*t+.7*i),M.bringToFront(O)}1===snowman.current.arms&&S.bringToFront(O),1===snowman.current.head&&T.sendToBack(B),P=(n+t+i+c)/1.1,a(),B.originX="bottom",B.originY="center",B.selectable=!1,B.top=e(C,52),C.add(B),B.centerH()}function a(){snowman.scale=.85*k/P,TweenMax.to(B,1,{scaleY:snowman.scale,scaleX:snowman.scale,onUpdate:f})}function o(e,n,t,a){"base"===e||"torso"===e||"head"===e?(snowman.snowmanElements[e][n]={},snowman.snowmanElements[e][n].image=new fabric.Image(t[n]),snowman.snowmanElements[e][n].image.selectable=!1,snowman.snowmanElements[e][n].image.setOpacity(0),snowman.snowmanElements[e][n].image.OriginY="center",snowman.snowmanElements[e][n].image.OriginX="center",snowman.snowmanElements[e][n].image.setScaleX(.4),snowman.snowmanElements[e][n].image.setScaleY(.4),"base"===e?snowman.snowmanElements[e][n].strength=$(t[n]).data("strength"):snowman.snowmanElements[e][n].weight=$(t[n]).data("weight"),snowman.snowmanElements[e][n].image.newOpacity=0,snowman.snowmanElements[e][0].image.setOpacity(1)):"arms"===e?(snowman.snowmanElements[e][n]={},snowman.snowmanElements[e][n].left=new fabric.Image(t[n]),snowman.snowmanElements[e][n].left.selectable=!1,snowman.snowmanElements[e][n].left.setOpacity(0),snowman.snowmanElements[e][n].left.OriginY="center",snowman.snowmanElements[e][n].left.OriginX="center",snowman.snowmanElements[e][n].left.setScaleX(.4),snowman.snowmanElements[e][n].left.setScaleY(.4),snowman.snowmanElements[e][n].left.newOpacity=0,snowman.snowmanElements[e][0].left.setOpacity(1),snowman.snowmanElements[e][n].right=new fabric.Image(a[n]),snowman.snowmanElements[e][n].right.selectable=!1,snowman.snowmanElements[e][n].right.setOpacity(0),snowman.snowmanElements[e][n].right.OriginY="center",snowman.snowmanElements[e][n].right.OriginX="center",snowman.snowmanElements[e][n].right.setScaleX(.4),snowman.snowmanElements[e][n].right.setScaleY(.4),snowman.snowmanElements[e][n].right.newOpacity=0,snowman.snowmanElements[e][0].right.setOpacity(1)):(snowman.snowmanElements[e][n]=new fabric.Image(t[n]),snowman.snowmanElements[e][n].selectable=!1,snowman.snowmanElements[e][n].setOpacity(0),snowman.snowmanElements[e][n].OriginY="center",snowman.snowmanElements[e][n].OriginX="center",snowman.snowmanElements[e][n].setScaleX(.4),snowman.snowmanElements[e][n].setScaleY(.4),snowman.snowmanElements[e][n].newOpacity=0,snowman.snowmanElements[e][0].setOpacity(1))}function s(){$(".background-slide").each(function(e){snowman.snowmanElements.scene[e]=$(this),$(this).addClass("background-slide-inactive")}),snowman.snowmanElements.scene[0].removeClass("background-slide-inactive"),snowman.snowmanElements.scene[0].addClass("background-slide-active")}function m(){for(i=0;i<D.length;i++)o("base",i,D)}function r(){for(i=0;i<z.length;i++)o("arms",i,z,N)}function l(){for(i=0;i<ne.length;i++)o("torso",i,ne)}function c(){for(i=0;i<se.length;i++)o("head",i,se)}function d(){for(i=0;i<le.length;i++)o("face",i,le)}function w(){for(i=0;i<ue.length;i++)o("hat",i,ue)}function u(e,n){switch(n.toString()){case"hat":T.remove(e);break;case"face":T.remove(e);break;case"head":T.remove(e.image);break;case"torso":O.remove(e.image);break;case"arms":O.remove(e.left),O.remove(e.right);break;case"base":B.remove(e.image);break;case"scene":C.remove(e)}}function h(e,n){var a=snowman.current[e],o="";o="prev"===n?0===a?snowman.snowmanElements[e].length-1:snowman.current[e]-1:a===snowman.snowmanElements[e].length-1?0:snowman.current[e]+1,snowman.current[e]=o,"scene"===e?(snowman.snowmanElements[e][a].addClass("background-slide-inactive"),snowman.snowmanElements[e][a].removeClass("background-slide-active"),snowman.snowmanElements[e][o].removeClass("background-slide-inactive"),snowman.snowmanElements[e][o].addClass("background-slide-active")):"arms"===e?(TweenMax.to(snowman.snowmanElements[e][a].left,.75,{opacity:0,onUpdate:f,onComplete:u,onCompleteParams:[snowman.snowmanElements[e][a],e]}),TweenMax.to(snowman.snowmanElements[e][o].left,.75,{opacity:1}),TweenMax.to(snowman.snowmanElements[e][a].right,.75,{opacity:0,onComplete:u,onCompleteParams:[snowman.snowmanElements[e][a],e]}),TweenMax.to(snowman.snowmanElements[e][o].right,.75,{opacity:1})):"base"!=e&&"torso"!=e&&"head"!=e?(TweenMax.to(snowman.snowmanElements[e][a],.75,{opacity:0,onUpdate:f,onComplete:u,onCompleteParams:[snowman.snowmanElements[e][a],e]}),TweenMax.to(snowman.snowmanElements[e][o],.75,{opacity:1})):(TweenMax.to(snowman.snowmanElements[e][a].image,.75,{opacity:0,onUpdate:f,onComplete:u,onCompleteParams:[snowman.snowmanElements[e][a],e]}),TweenMax.to(snowman.snowmanElements[e][o].image,.75,{opacity:1})),t()}function g(){s(),m(),r(),l(),c(),d(),w(),t(),a()}function f(){C.renderAll()}function b(){$("#build-scene").addClass("build-scene-inactive"),$("#build-toolbar").addClass("build-toolbar-inactive"),$(".js-to-share-mode:not(.header-cta)").addClass("cta-hidden"),$("header").find(".js-to-share-mode").addClass("cta-disabled"),$("header").find(".js-to-share-mode").html("Testing..."),$(".tutorial-element").addClass("tutorial-element-inactive");var e=snowman.snowmanElements.base[snowman.current.base].strength,n=snowman.snowmanElements.torso[snowman.current.torso].weight,t=snowman.snowmanElements.head[snowman.current.head].weight;e>=n+t?E():p()}function p(){var e=new TimelineMax({onUpdate:f,onComplete:v,onCompleteParams:["fail"]});e.to(B,3,{angle:15,repeat:1,yoyo:!0,ease:Elastic.easeIn.config(.8,.2)}).staggerTo([O,T],2.8,{left:"+=85",repeat:1,yoyo:!0,ease:Elastic.easeIn.config(.8,.2)},.1,"-=6").to(j,.5,{top:"-="+C.height/2,ease:Power1.easeOut,repeat:1,yoyo:!0}).to(j,1,{angle:"+=1600",ease:Power1.easeInOut},"-=1").to(j,1,{left:"-="+C.width/4,ease:Power1.easeOut},"-=1").to(O,.5,{top:"-="+C.height/1.5,ease:Power1.easeOut,repeat:1,yoyo:!0},"-=1").to(O,.25,{top:"+="+C.height/2.5,ease:Power1.easeOut}).to(O,1.25,{left:"+="+C.width/2,angle:"-=195",ease:Power1.easeInOut},"-=1.25").to(T,1.5,{top:"-="+5*C.height,ease:Power1.easeOut,repeat:1,yoyo:!0},"-=1.25").to(T,.25,{angle:"+=180"},"-=1.5").to(T,.4,{top:"+="+C.height/1.7,ease:Power1.easeOut}).to(T,1.5,{top:"+=25",scaleX:"+=.1",scaleY:"+=.1"},"+=.5")}function E(){var e=new TimelineMax({onUpdate:f,onComplete:v,onCompleteParams:["success"]});e.to(B,3,{angle:15,repeat:1,yoyo:!0,ease:Elastic.easeIn.config(.8,.2)}).staggerTo([O,T],2.8,{left:"+=15",repeat:1,yoyo:!0,ease:Elastic.easeIn.config(.8,.2)},.1,"-=6"),y()}function v(e){function t(){snowman.isSharePosition=!0,window.innerWidth>880?TweenMax.to(B,.75,{left:n(C,15)+j.width*j.scaleX/2,ease:Back.easeInOut,onUpdate:f}):TweenMax.to(B,.75,{left:-4*n(C,15),ease:Back.easeInOut,onUpdate:f}),$("#success-scene-title").removeClass("end-title-inactive")}function a(){snowman.isSharePosition=!0,snowman.isDead=!0,window.innerWidth>880?(TweenMax.to([j,O,T],.75,{left:0,onUpdate:f},.2),TweenMax.to(B,.75,{left:n(C,25)+j.width*j.scaleX/2,ease:Back.easeInOut,onUpdate:f})):(TweenMax.to([j,O,T],.75,{left:0,onUpdate:f},.2),TweenMax.to(B,.75,{left:-4*n(C,25),ease:Back.easeInOut,onUpdate:f})),$("#failure-scene-title").removeClass("end-title-inactive")}$(".js-back-to-build-mode").removeClass("cta-hidden"),$("#build-toolbar").addClass("build-toolbar-excels-cta"),$("#build-toolbar").removeClass("build-toolbar-inactive"),$("header").find(".js-to-share-mode").addClass("cta-hidden"),$("header").find(".js-to-share-mode").removeClass("cta-disabled"),$("header").find(".js-to-share-mode").html("TEST YOUR SNOWMAN"),"success"===e?t():a(),$(".js-back-to-build-mode").one(theUniqueEvent,function(e){if(snowman.isDead){for(var t in snowman.current)snowman.current[t]=0;g(),snowman.isDead=!1}snowman.toBuildMode.backToBuildMode(),TweenMax.to(B,.75,{left:n(C,50),ease:Back.easeInOut,onUpdate:f}),$(".js-to-share-mode").one(theUniqueEvent,function(e){snowman.isSharePosition=!0,b()})})}function y(){function n(n){function t(){var e=new Date,n=e.getDate(),t=e.getMonth()+1,a=e.getFullYear(),o=t+"_"+n+"_"+a;return o}var a=new fabric.Image("excels-holiday-message"),o=fabric.util.object.clone(B);I.add(a),a.originX="right",a.originY="bottom",a.scaleX=.9,a.scaleY=.9,a.left=I.width,a.top=I.height,I.add(o),o.scaleX=1.25,o.scaleY=1.25,o.centerH(),o.top=e(I,50),I.renderAll(),$(".js-download")[0].href=I.toDataURL({format:"jpeg",quality:.5}),"download"in document.createElement("a")?$(".js-download")[0].download="My_Snowman_"+t()+".jpg":$(".js-download")[0].target="_blank"}var t=$(".background-slide-active").css("background-image").slice(4,-1).replace(/"/g,"");fabric.Image.fromURL(t,function(e){I.add(e),e.scaleX=.5,e.scaleY=.5,n()})}var C=new fabric.Canvas("snowman-canvas");snowman.canvas=C;var k=window.innerHeight-($("header").height()+$("#build-toolbar").height());C.setDimensions({width:window.innerWidth,height:k}),C.top=85,C.renderOnAddRemove=!1,C.selection=!1;var I=new fabric.StaticCanvas("snowman-offscreen-download-canvas");I.setDimensions({width:1500,height:900}),I.renderOnAddRemove=!1;var B,O,T,j,M,S,U,x,X,H,P;B=new fabric.Group;var Y=document.getElementById("base-classic"),W=document.getElementById("base-future"),q=document.getElementById("base-western"),D=[Y,W,q],A=document.getElementById("left-arm-classic"),R=document.getElementById("left-arm-future"),_=document.getElementById("left-arm-western"),F=document.getElementById("right-arm-classic"),G=document.getElementById("right-arm-future"),L=document.getElementById("right-arm-western"),z=[A,R,_],N=[F,G,L],J=document.getElementById("torso-classic"),K=document.getElementById("torso-future"),Q=document.getElementById("torso-western"),V=document.getElementById("torso-classic-hopkins"),Z=document.getElementById("torso-future-hopkins"),ee=document.getElementById("torso-western-hopkins"),ne=[J,K,Q,V,Z,ee],te=document.getElementById("head-classic"),ae=document.getElementById("head-future"),oe=document.getElementById("head-western"),se=[te,ae,oe],ie=document.getElementById("face-classic"),me=document.getElementById("face-future"),re=document.getElementById("face-western"),le=[ie,me,re],ce=document.getElementById("hat-classic"),de=document.getElementById("hat-future"),we=document.getElementById("hat-western"),ue=[ce,de,we];g(),$(".build-button").bind(theUniqueEvent,function(e){var n=$(this).data("direction");h(snowman.toModify,n)}),$("#build-scene").bind("touchstart",function(e){var n=e.originalEvent.touches[0].pageX;$("#build-scene").bind("touchend",function(e){var t=e.originalEvent.changedTouches[0].pageX,a="";n>t&&n-t>25?(a="next",h(snowman.toModify,a)):t>n&&t-n>25&&(a="prev",h(snowman.toModify,a)),$("#build-scene").unbind("touchend")})}),f(),$(".js-to-share-mode").one(theUniqueEvent,function(e){snowman.isSharePosition=!0,b()}),$(window).resize(function(t){k=window.innerHeight-($("header").height()+$("#build-toolbar").height()),C.setDimensions({width:window.innerWidth,height:k}),snowman.isSharePosition?snowman.isDead?window.innerWidth>880?B.left=n(C,25)+j.width*j.scaleX/2:B.left=-4*n(C,25):window.innerWidth>880?B.left=n(C,15)+j.width*j.scaleX/2:B.left=-4*n(C,15):B.centerH(),B.top=e(C,52),a()}),$(".js-to-build-mode").one("click",function(e){$("header").removeClass("header-intro"),$("#intro-scene").addClass("intro-scene-inactive"),window.setTimeout(function(){$("#intro-scene").hide()},500),snowmanHistory.object.title="build",snowmanHistory.fire(),document.getElementById("audio-song").play()}),window.addEventListener("popstate",function(e){snowmanHistory.currentState.title&&"build"===snowmanHistory.currentState.title&&($("#leave-modal").addClass("modal-active"),$("#leave").bind(theUniqueEvent,function(){history.go(-1)}),$("#stay").bind(theUniqueEvent,function(){snowmanHistory.fire(),$("#leave-modal").removeClass("modal-active"),$("#leave").unbind(theUniqueEvent),$("#stay").unbind(theUniqueEvent)}))})},toBuildMode:{backToBuildMode:function(){snowman.isSharePosition=!1,$("#build-scene").removeClass("build-scene-inactive"),$("#build-toolbar").removeClass("build-toolbar-excels-cta build-toolbar-inactive"),$(".js-to-share-mode").removeClass("cta-hidden"),$(".js-back-to-build-mode").addClass("cta-hidden"),$(".js-download").unbind(theUniqueEvent),$("#success-scene-title").addClass("end-title-inactive"),$("#failure-scene-title").addClass("end-title-inactive")}}},snowmanHistory={object:{title:"initial"},url:"",currentState:history.state,fire:function(){window.history.pushState(history.object,"",snowmanHistory.url),snowmanHistory.currentState=snowmanHistory.object}},toolbar={init:function(){$(".build-toolbar-button").bind(theUniqueEvent,function(){$(".build-toolbar-button").not($(this)).removeClass("build-toolbar-button-active"),$(this).addClass("build-toolbar-button-active"),snowman.toModify=$(this).data("target")})}},audio={init:function(){function e(){$("#js-audio-mute").bind(theUniqueEvent,function(e){$(this).hasClass("volume-muted")?$(this).hasClass("volume-muted")&&($(this).removeClass("volume-muted"),n.muted=!1,n.play()):($(this).addClass("volume-muted"),n.muted=!0,n.pause())})}var n=document.getElementById("audio-song");n.play(),e()}},share={button:"",init:function(){var e={ui:{buttonText:"SHARE THIS"},networks:{googlePlus:{enabled:!0},twitter:{enabled:!0},facebook:{enabled:!0,app_id:"1521351971514372"},pinterest:{enabled:!0},reddit:{enabled:!1},linkedin:{enabled:!0},whatsapp:{enabled:!1},email:{enabled:!1}}};share.button=new ShareButton(".js-share",e)}},tutorial={init:function(){$(".tutorial-element").find(".tutorial-confirm").bind(theUniqueEvent,function(e){$(this).closest(".tutorial-element").addClass("tutorial-element-inactive"),$(this).closest(".tutorial-element").is("#snowman-tutorial-elements")&&$("#toolbar-tutorial-elements").removeClass("tutorial-element-hidden-box"),$(this).closest(".tutorial-element").is("#toolbar-tutorial-elements")&&$("#build-button-tutorial-elements").removeClass("tutorial-element-hidden-box")}),$(".tutorial-bubble-outer").bind(theUniqueEvent,function(e){$(".tutorial-element").not($(this).closest(".tutorial-element")).addClass("tutorial-element-hidden-box"),$(this).closest(".tutorial-element").toggleClass("tutorial-element-hidden-box")})}},reduceBgImages={hasBeenChanged:!1,init:function(){window.innerWidth<992&&reduceBgImages.hasBeenChanged===!1&&($("#background-slide-classic").css("background",'white url("../images/scene-classic-small.jpg") center;'),$("#background-slide-future").css("background",'white url("../images/scene-future-small.jpg") center;'),$("#background-slide-western").css("background",'white url("../images/scene-western-small.jpg") center;'),$("#intro-scene").css("background",'#05254c url("../images/scene-night.jpg") top center no-repeat;'),reduceBgImages.hasBeenChanged=!0)}},isTouchEnabled=isTouchDevice();theUniqueEvent=isTouchEnabled===!0?"touchstart":"click",$(window).load(function(){snowman.init(),toolbar.init(),share.init(),tutorial.init(),reduceBgImages.init(),audio.init(),$("#loading-modal").removeClass("modal-active")}),$(window).resize(function(e){reduceBgImages.init(),window.innerWidth>=992&&reduceBgImages.hasBeenChanged===!0&&($("#background-slide-classic #background-slide-future #background-slide-western #intro-scene").css("background",""),reduceBgImages.hasBeenChanged=!1)});
